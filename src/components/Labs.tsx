  ...
  return (
    <section id="cyber-labs" className="sec-pad gradient-projects relative overflow-hidden">
      ...
      <div className="main-container relative z-10">
        ...
        <p className="heading-sec__sub text-center mb-12 animate-fade-in-up opacity-90">
          ...
          {labProjects.map((project, index) => (
            ...
            >
              ...
              <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
                <div className="gradient-card p-5 rounded-2xl backdrop-blur-lg border border-white/10 hover:border-white/20 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-500/20 group relative">
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    <span className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold text-white bg-gradient-to-r ${getCategoryColor(project.category)} shadow-lg`}>
                      {getCategoryIcon(project.category)} {project.category}
                    </span>
                    <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-gray-600/50 text-gray-300 border border-gray-500/50">
                      {project.provider}
                    </span>
                  </div>

                  <h3 className="text-xl font-bold mb-3 leading-tight bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent group-hover:from-orange-300 group-hover:to-red-300 transition-all duration-500">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-3">
                    {project.skills.map((skill, i) => (
                      <span
                        key={skill}
                        className={`px-2.5 py-0.5 text-xs font-medium rounded-full bg-gradient-to-r ${getCategoryColor(project.category)}/20 border border-current/30 text-current backdrop-blur-sm hover:scale-105 transition-transform duration-200`}
                        style={{
                  ...
                  <p className="text-primary mb-4 leading-relaxed text-sm opacity-90">
                    {project.description}
                  </p>
                  ...
                  <a
                    ...
                    className={`btn-gradient inline-flex items-center gap-2 px-5 py-2.5 rounded-full font-semibold text-white text-sm transition-all duration-300 hover:scale-105 group bg-gradient-to-r ${getCategoryColor(project.category)} hover:shadow-lg hover:shadow-current/30`}
                  >
                    {project.buttonText}
                    <svg
              ...
              <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                <div className="relative group">
                  ...
                  {/* Verified Badge */}
                  <div className="absolute -top-2 -right-2 z-20 px-2.5 py-0.5 bg-gradient-to-r from-green-400 to-emerald-500 text-white text-xs font-bold rounded-full shadow-lg transform rotate-12 group-hover:rotate-6 transition-transform duration-300 flex items-center gap-1">
                    ✓ Verified
                  </div>

                  {/* Neural Activity Indicator */}
                  <div className="absolute top-3 left-3 z-20 text-xl opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-110">
                    🧠
                  </div>
        ...
        <div className="text-center mt-10 animate-fade-in-up relative z-10" style={{ animationDelay: '1.2s' }}>
          <div className="gradient-card p-5 rounded-2xl backdrop-blur-lg border border-white/10 inline-block relative overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-6 text-center relative z-10">
              <div className="group cursor-pointer">
                <div className="text-2xl font-bold bg-gradient-to-r from-red-400 to-orange-500 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">5+</div>
                <div className="text-xs text-gray-400">Certificates</div>
                <div className="w-6 h-0.5 bg-gradient-to-r from-red-400 to-orange-500 mx-auto mt-2 transform scale-0 group-hover:scale-100 transition-transform duration-300"></div>
              </div>
              <div className="group cursor-pointer">
                <div className="text-2xl font-bold bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">25+</div>
                <div className="text-xs text-gray-400">Skills Learned</div>
                <div className="w-6 h-0.5 bg-gradient-to-r from-green-400 to-teal-500 mx-auto mt-2 transform scale-0 group-hover:scale-100 transition-transform duration-300"></div>
              </div>
              <div className="group cursor-pointer">
                <div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">100+</div>
                <div className="text-xs text-gray-400">Hours Studied</div>
                <div className="w-6 h-0.5 bg-gradient-to-r from-blue-400 to-purple-500 mx-auto mt-2 transform scale-0 group-hover:scale-100 transition-transform duration-300"></div>
              </div>
            </div>
          </div>
        </div>
